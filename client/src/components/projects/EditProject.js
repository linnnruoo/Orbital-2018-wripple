...
class NewProject extends Component {
  ...
  componentDidMount(){
    this.setState({
      title: this.props.curr_project.title,
      subtitle: this.props.curr_project.subtitle,
      summary: this.props.curr_project.summary,
      details: this.props.curr_project.details,
      team_size: this.props.curr_project.team_size,
      commitment_lvl: this.props.curr_project.commitment_lvl,
      looking_for: this.props.curr_project.looking_for
    })
  }
  ...
  onSubmit = e => {
    ...
    this.props.editProject(this.props.match.params.projectId, editedProject, this.props.history);
        ...
        <div className="card shadow">
          <div className="card-body">
            ...
            <div className="grid">
              ...
              <div className="row">
                <input type="submit" className="btn btn-success mx-auto" value="Save Changes" />
              </div>
...
const mapStateToProps = (state) => ({
  auth: state.auth,
  errors: state.errors,
  curr_project: state.project.single_project
})

export default connect(mapStateToProps, { editProject })(withRouter(NewProject));